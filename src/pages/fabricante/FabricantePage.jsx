...
function ScrollTable({ children }) {
  return <div style={{ overflowX:'auto', WebkitOverflowScrolling:'touch', borderRadius:8 }}><table style={{ width:'100%', borderCollapse:'collapse', fontSize:'.72rem', minWidth:520 }}>{children}</table></div>
}
