...
export default function ClientePage() {
  ...
  const act = useCallback((type,detail)=>{ if(type==='toast'){showToast(detail);return} if(type==='goto'){changeSection(detail);return} if(type==='comunicar'||type==='enviar_mensaje'){setCanalDest(detail||'');setCanalOpen(true);return} setModal(buildModal(type,detail,showToast)) },[showToast,changeSection])
